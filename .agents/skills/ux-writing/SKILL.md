...
**Compatible with:** Codex, Codex, Cursor, and other agents that support the agent skills specification.
...
- **docs/figma-integration.md**: Guide for using this skill with Figma MCP (Codex, Codex, and Cursor)